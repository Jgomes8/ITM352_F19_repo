...
app.get('/set_cookie', function (request, response) { //we're using this to send a cookie with your name data when this route is called
    response.cookie('myname', 'Joey Gomes').send('cookie set'); //We're taking the response, then setting cookie identifier (myname) and giving it data (Joey Gomes). Then we will send a response back w/ message 'cookie sent'
});
