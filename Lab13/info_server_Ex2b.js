...
function displayPurchase(POST, response) {
    ...
    if(isNonNegInt(q)) { //Here we are checking that, if its a NonNegInt, itll check whats in our textbox. If it fulfills the NonNeg check/is true, itll doc.write. If its false itll do nothing and stay on the page.
